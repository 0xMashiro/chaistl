...
// ============================================================================
// weight_balanced_multimap - multimap alias using weight-balanced policy
// ============================================================================
...
using weight_balanced_multimap = multimap<Key, T, Compare, Allocator, detail::tree::weight_balanced_tree_policy>;
